  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.searchWrap}>
        ...
        <Text style={styles.searchText}>Search for a Space</Text>
      </View>

      <ScrollView style={styles.content} contentContainerStyle={styles.contentInner}>
        <Text style={styles.happeningTitle}>Happening Now</Text>
        <Text style={styles.happeningSubtitle}>Spaces going on right now</Text>
        ...
        {SPACE_CARDS.map((card) => (
          <View key={card.id} style={styles.spaceCard}>
            ...
            <View style={styles.listenersRow}>
              ...
              <Text style={styles.listenersText}>{card.listening}</Text>
            </View>
              ...
              <View style={styles.hostMeta}>
                <View style={styles.hostTopLine}>
                  ...
                  <View style={styles.roleBadge}>
                    <Text style={styles.roleText}>{card.hostRole}</Text>
                  </View>
                </View>
                <Text style={styles.hostBio}>{card.hostBio}</Text>
              </View>
            </View>
          </View>
        ))}
