    ...
    <View style={styles.container}>
      <View style={[styles.header, { paddingTop: insets.top + 8 }]}> 
        ...
        <TouchableOpacity style={styles.headerIconButton} activeOpacity={0.84}>
          <CircleQuestionMark size={29} color="#f2f2f2" />
        </TouchableOpacity>
      </View>

      <ScrollView style={styles.content} contentContainerStyle={styles.contentInner}>
        <Text style={styles.title}>Make money on X</Text>
        ...
        <TouchableOpacity style={styles.linkButton} activeOpacity={0.84}>
          ...
          <ChevronRight size={24} color="#1d9bf0" />
        </TouchableOpacity>
            ...
            <View style={styles.cardMediaPlaceholder}>
              <View style={styles.mockPhone}>
                <View style={styles.mockBanner}>
                  <Text style={styles.mockBannerTitle}>You got paid!</Text>
                  <Text style={styles.mockBannerAmount}>$816.54 has been deposited into your account.</Text>
                </View>
              </View>
            </View>
          </View>
